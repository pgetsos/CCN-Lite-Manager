...
def run_auto_22():
	...
	while True:
		...
		search_content_auto(local_address, 6, "2.1-"+counter)
		time.sleep(1)
		search_content_auto(local_address, 7, "2.2-"+counter)
		search_content_auto(local_address, 8, "2.3-"+counter)
		search_content_auto(local_address, 9, "2.4-"+counter)
		search_content_auto(local_address, 10, "2.5-"+counter)

		time.sleep(3)

		search_content_auto(local_address,  6, "2.6-"+counter)
		search_content_auto(local_address,  7, "2.7-"+counter)
		search_content_auto(local_address,  8, "2.8-"+counter)
		search_content_auto(local_address,  9, "2.9-"+counter)
		search_content_auto(local_address, 10, "2.10-"+counter)
